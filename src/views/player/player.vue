<template>
  <div class="player" v-if="playList.length">
      ...
      <div class="nomal-player" v-show="fullScreen">
        ...
        <div class="bottom">
          <div class="progress-wrapper">
            <span class="time tile-l">{{format(currentTime)}}</span>
    ...
    <audio
      ...
      @canplay="ready"
      @error="error" ref="audio" :src="currentSong.url"></audio>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    percentChange (p) {
      this.$refs.audio.currentTime = this.duration * p
      if (!this.playing) {
        this.togglePlay()
      }
    },
